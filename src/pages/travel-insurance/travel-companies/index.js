...
const TravelCompanies = () => {
  ...
  const getCompaniesNameList = () => {
    ...
    dispatch(getAllCarCompanies({ key: "travel", search: "" }))
      .unwrap()
      .then((res) => {
        setIsLoading(false);
        setAllData(res);
          ...
          <Stack direction="row" justifyContent="space-between" spacing={4} mb={3}>
            ...
            {moduleAccess(user, "companies.create") && (
              <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
                <NextLink href={`/travel-insurance/travel-companies/create`} passHref>
                  <Button
                    startIcon={
                ...
                >
                  ...
                  <Stack direction="row" spacing={1} mt={1}>
                    {moduleAccess(user, "companies.update") && (
                      <NextLink href={`/travel-insurance/travel-companies/${company?._id}/edit`} passHref>
                        <ActionButton
                          startIcon={
                            <SvgIcon fontSize="small">
                              <EditIcon />
