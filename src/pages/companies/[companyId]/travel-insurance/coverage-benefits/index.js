...
const TravelCoverageBenefits = () => {
  const dispatch = useDispatch();
  const { benefitsList, benefitsValues, coveragesValues, coveragesList } = useSelector((state) => state.company);
...
TravelCoverageBenefits.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;

export default TravelCoverageBenefits;
