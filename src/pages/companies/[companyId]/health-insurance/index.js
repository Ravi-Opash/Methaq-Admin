...
const HealthCompanyPage = () => {
  ...
  // Get company detail API calling
            ...
            <Grid container justifyContent="space-between" spacing={3} mt={1}>
              ...
              >
                ...
                <div>
                  ...
                  >
                    <Typography variant="subtitle2">Health Insurance Company</Typography>
                  </Box>
                </div>
              </Grid>
            </Grid>
            ...
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                <Stack sx={{ display: "flex", flexDirection: "row", gap: 1, ml: 2 }}>
                  <Chip
                    onClick={() => router.push(`/companies/${companyId}/health-insurance/tpa`)}
                  ...
                  <Chip
                    ...
                    onClick={() => router.push(`/companies/${companyId}/health-insurance/conditions`)}
                    label="Conditions"
                    sx={{
                      height: 40,
                      borderRadius: 20,
...
HealthCompanyPage.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;

export default HealthCompanyPage;
