...
const Chart = ({ dateStatus, promoCodeOverviewData, loading }) => {
  ...
  useEffect(() => {
    ...
    if (promoCodeOverviewData) {
      // Applied
      promoCodeOverviewData?.promoCodeUtilization?.forEach((promo) => {
      ...
      promoCodeOverviewData?.promoCodeApplied?.forEach((promo) => {
