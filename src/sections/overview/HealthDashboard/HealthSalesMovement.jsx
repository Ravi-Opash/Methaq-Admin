...
import { Card, CircularProgress, Box, Button } from "@mui/material";
import dynamic from "next/dynamic";
import { numberToMonth } from "src/utils/numberToMonth";
import { eachDayOfInterval, startOfMonth, subMonths, format } from "date-fns";
import { dateToShortDate } from "src/utils/dateToShortDate";
const ReactApexChart = dynamic(() => import("react-apexcharts"), {
  ssr: false,
});

const HealthSalesMovement = ({
  dateStatus,
  data,
  totalHealthSalesMovementListLoader,
  changeHealthSalesMovmentHandler,
  calendar,
}) => {
  ...
  const handleMonthWise = () => {
    changeHealthSalesMovmentHandler("month");
  };

  const handleDayWise = () => {
    changeHealthSalesMovmentHandler("day");
  };
...
export default HealthSalesMovement;
