...
const HealthDashBoardPromoCode = ({ dateStatus, healthPromoCodeOverviewData, loading }) => {
  const [data, setdata] = useState([]);

  useEffect(() => {
    const agentMap = new Map();

    if (healthPromoCodeOverviewData) {
      // Applied
      healthPromoCodeOverviewData?.promoCodeUtilization?.forEach((promo) => {
      ...
      healthPromoCodeOverviewData?.promoCodeApplied?.forEach((promo) => {
...
export default HealthDashBoardPromoCode;
