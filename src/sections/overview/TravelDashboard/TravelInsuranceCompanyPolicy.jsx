...
function TravelInsuranceCompanyPolicy({
  handleClose,
  items = [],
  rowsPerPage,
  page,
            ...
            <TableBody>
              <>
                <TableRow sx={{ cursor: "default" }}>
                  <TableCell>
                    {companyData?.noOfProposalsCompanyWise?.company
                      ? companyData?.noOfProposalsCompanyWise?.company
                      : "-"}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    {companyData?.conversionRatioData?.noOfPolicies ? formateWithoutDasimal(companyData?.conversionRatioData?.noOfPolicies) : "0"}
                  </TableCell>
                  <TableCell>
                    {companyData?.conversionRatioData?.conversionRatio ? `${formatNumber(companyData?.conversionRatioData?.conversionRatio)}%` : "0%"}
                  </TableCell>
                </TableRow>
              </>
            </TableBody>
                  ...
                  {items?.map((ele, idx) => {
                    return (
                      <TableRow key={idx}>
                        ...
                        <TableCells>
                          <NextLink href={`/travel-insurance/policies/${ele?._id}`} passHref>
...
export default TravelInsuranceCompanyPolicy;
