...
function TravelAgentPerfomance({ handleClose, travelAgentWiseList, agentData }) {
      ...
      >
        ...
        <Scrollbar>
          <Box sx={{ minWidth: 700, mt: 3 }}>
            {travelAgentWiseList?.proposalsPolicy ? (
              <Table>
                <TableHead>
                  <TableRow>
                ...
                <TableBody>
                  <>
                    {travelAgentWiseList?.proposalsPolicy?.map((ele, index) => {
                      return (
                        <TableRow key={index} sx={{ cursor: "default" }}>
                          <TableCell>
                            <Tooltip title="Visit Proposal">
                              <Typography
                                component={Link}
                                href={`/travel-insurance/proposals/${ele?.policy?.quote?.proposalId}`}
                                sx={{
                                  fontSize: 14,
                                  cursor: "pointer",
                                  width: "max-content",
                          ...
                          <TableCell>
                            <Tooltip title="Visit Policy">
                              <Typography
                                component={Link}
                                href={`/travel-insurance/policies/${ele?.policy?._id}`}
                                sx={{
                                  fontSize: 14,
                                  cursor: "pointer",
                                  width: "max-content",
...
export default TravelAgentPerfomance;
