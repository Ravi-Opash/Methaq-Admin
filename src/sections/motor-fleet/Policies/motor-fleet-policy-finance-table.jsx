...
} from "../../travel-insurance/Policies/action/travelPoliciesAction";
...
function MotorFleetPolicyFinanceTable({ travelPolicyDeatils }) {
...
export default MotorFleetPolicyFinanceTable;
