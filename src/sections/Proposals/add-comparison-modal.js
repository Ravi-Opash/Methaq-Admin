...
const AddComparisonModal = ({ handleComparisonModalClose, proposalQuotationFullList, Ids, selectedQuotes }) => {
  const router = useRouter();

  const dispatch = useDispatch();
  // const { proposalQuotationFullList } = useSelector(
  ...
  const [selectedCheckboxes, setSelectedCheckboxes] = useState(selectedQuotes || []);
