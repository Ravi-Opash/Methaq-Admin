...
import { setWorkmenCompensationSearchfilter } from "./Reducer/workmenCompensationSlice";
...
export default function WorkmenCompensationListTable(props) {
  const {
    count = 0,
    item = [],
    onPageChange = () => {},
  ...
  const onClickHandler = () => {
    dispatch(
      setWorkmenCompensationSearchfilter({ ...workmenCompensationSearchFilter, scrollPosition: window?.scrollY })
    );
  };
  return (
    <Card>
                ...
                return (
                  <>
                    <TableRow
                      ...
                      component={Link}
                      href={`/workmen-compensation/${commercial?.workmensCompensationNumber}`}
                      onClick={() => onClickHandler()}
                    >
                      <TableCell>{commercial?.workmensCompensationNumber}</TableCell>
