...
import { applyDiscountToHealthProposals } from "./Action/healthInsuranceAction";
import { getPromoCodeList } from "src/sections/Proposals/Action/proposalsAction";
import { toast } from "react-toastify";
import AnimationLoader from "src/components/amimated-loader";

export default function HealthPromoCodeSession({
  proposalId,
  items,
  ...
  const handlePromoCodeChange = (e) => {
    ...
    dispatch(applyDiscountToHealthProposals({ proposalId: proposalId, data: data }))
      .unwrap()
      .then((res) => {
        setLoading(false);
